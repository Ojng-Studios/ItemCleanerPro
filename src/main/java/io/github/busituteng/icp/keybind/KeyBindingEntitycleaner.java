...
package io.github.busituteng.icp.keybind;
...
import io.github.busituteng.icp.procedure.ProcedureEntitycleanerOnKeyPressed;
import io.github.busituteng.icp.IcpMod;
import io.github.busituteng.icp.ElementsIcpMod;

@ElementsIcpMod.ModElement.Tag
public class KeyBindingEntitycleaner extends ElementsIcpMod.ModElement {
	private KeyBinding keys;
	public KeyBindingEntitycleaner(ElementsIcpMod instance) {
		super(instance, 3);
	}
	...
	public void init(FMLInitializationEvent event) {
		keys = new KeyBinding("key.mcreator.entitycleaner", Keyboard.KEY_1, "key.categories.misc");
	...
	public void onKeyInput(InputEvent.KeyInputEvent event) {
		if (Minecraft.getMinecraft().currentScreen == null) {
			if (org.lwjgl.input.Keyboard.isKeyDown(keys.getKeyCode())) {
				IcpMod.PACKET_HANDLER.sendToServer(new KeyBindingPressedMessage());
	...
	private static void pressAction(EntityPlayer entity) {
			...
			return;
		{
			...
			ProcedureEntitycleanerOnKeyPressed.executeProcedure($_dependencies);
		}
	}
}
