...
import io.github.busituteng.icp.procedure.ProcedureItclCommandExecuted;
import io.github.busituteng.icp.IcpMod;
import io.github.busituteng.icp.ElementsIcpMod;

@ElementsIcpMod.ModElement.Tag
public class KeyBindingItemcleaner extends ElementsIcpMod.ModElement {
	private KeyBinding keys;
	public KeyBindingItemcleaner(ElementsIcpMod instance) {
		super(instance, 2);
	}
	...
	public void init(FMLInitializationEvent event) {
		keys = new KeyBinding("key.mcreator.itemcleaner", Keyboard.KEY_0, "key.categories.misc");
	...
	private static void pressAction(EntityPlayer entity) {
			...
			return;
		{
			...
			ProcedureItclCommandExecuted.executeProcedure($_dependencies);
		}
	}
}
